...
pub const rawformat_t_RF_COMPRESSED: rawformat_t = 0;
pub const rawformat_t_RF_RGBA: rawformat_t = 1;
pub const rawformat_t_RF_BGRA: rawformat_t = 2;
pub const rawformat_t_RF_BGR: rawformat_t = 3;
pub const rawformat_t_RF_LUMINANCE: rawformat_t = 4;
pub type rawformat_t = ::core::ffi::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct bpc_desc_s {
    pub format: ::core::ffi::c_int,
    pub name: [::core::ffi::c_char; 16usize],
    pub rawformat: rawformat_t,
...
pub const window_mode_e_WINDOW_MODE_WINDOWED: window_mode_e = 0;
pub const window_mode_e_WINDOW_MODE_FULLSCREEN: window_mode_e = 1;
pub const window_mode_e_WINDOW_MODE_BORDERLESS: window_mode_e = 2;
pub const window_mode_e_WINDOW_MODE_COUNT: window_mode_e = 3;
pub type window_mode_e = ::core::ffi::c_uint;
pub use self::window_mode_e as window_mode_t;
...
pub const ref_window_type_e_REF_WINDOW_TYPE_SDL2: ref_window_type_e = 5;
pub const ref_window_type_e_REF_WINDOW_TYPE_SDL3: ref_window_type_e = 6;
...
pub const GL_KEEP_UNIT: _bindgen_ty_16 = -1;
pub const XASH_TEXTURE0: _bindgen_ty_16 = 0;
pub const XASH_TEXTURE1: _bindgen_ty_16 = 1;
pub const XASH_TEXTURE2: _bindgen_ty_16 = 2;
pub const XASH_TEXTURE3: _bindgen_ty_16 = 3;
pub const MAX_TEXTURE_UNITS: _bindgen_ty_16 = 32;
pub type _bindgen_ty_16 = ::core::ffi::c_int;
pub const RS_ACTIVE_TENTS: _bindgen_ty_17 = 0;
...
pub use self::ref_graphic_apis_e as ref_graphic_apis_t;
...
pub const REF_GL_RED_SIZE: _bindgen_ty_18 = 0;
pub const REF_GL_GREEN_SIZE: _bindgen_ty_18 = 1;
pub const REF_GL_BLUE_SIZE: _bindgen_ty_18 = 2;
pub const REF_GL_ALPHA_SIZE: _bindgen_ty_18 = 3;
pub const REF_GL_DOUBLEBUFFER: _bindgen_ty_18 = 4;
pub const REF_GL_DEPTH_SIZE: _bindgen_ty_18 = 5;
pub const REF_GL_STENCIL_SIZE: _bindgen_ty_18 = 6;
pub const REF_GL_MULTISAMPLEBUFFERS: _bindgen_ty_18 = 7;
pub const REF_GL_MULTISAMPLESAMPLES: _bindgen_ty_18 = 8;
pub const REF_GL_ACCELERATED_VISUAL: _bindgen_ty_18 = 9;
pub const REF_GL_CONTEXT_MAJOR_VERSION: _bindgen_ty_18 = 10;
pub const REF_GL_CONTEXT_MINOR_VERSION: _bindgen_ty_18 = 11;
pub const REF_GL_CONTEXT_EGL: _bindgen_ty_18 = 12;
pub const REF_GL_CONTEXT_FLAGS: _bindgen_ty_18 = 13;
pub const REF_GL_CONTEXT_PROFILE_MASK: _bindgen_ty_18 = 14;
pub const REF_GL_SHARE_WITH_CURRENT_CONTEXT: _bindgen_ty_18 = 15;
pub const REF_GL_FRAMEBUFFER_SRGB_CAPABLE: _bindgen_ty_18 = 16;
pub const REF_GL_CONTEXT_RELEASE_BEHAVIOR: _bindgen_ty_18 = 17;
pub const REF_GL_CONTEXT_RESET_NOTIFICATION: _bindgen_ty_18 = 18;
pub const REF_GL_CONTEXT_NO_ERROR: _bindgen_ty_18 = 19;
pub const REF_GL_ATTRIBUTES_COUNT: _bindgen_ty_18 = 20;
pub type _bindgen_ty_18 = ::core::ffi::c_uint;
pub const REF_GL_CONTEXT_PROFILE_CORE: _bindgen_ty_19 = 1;
pub const REF_GL_CONTEXT_PROFILE_COMPATIBILITY: _bindgen_ty_19 = 2;
pub const REF_GL_CONTEXT_PROFILE_ES: _bindgen_ty_19 = 4;
pub type _bindgen_ty_19 = ::core::ffi::c_uint;
pub const REF_GL_CONTEXT_DEBUG_FLAG: _bindgen_ty_20 = 1;
pub const REF_GL_CONTEXT_FORWARD_COMPATIBLE_FLAG: _bindgen_ty_20 = 2;
pub const REF_GL_CONTEXT_ROBUST_ACCESS_FLAG: _bindgen_ty_20 = 4;
pub const REF_GL_CONTEXT_RESET_ISOLATION_FLAG: _bindgen_ty_20 = 8;
...
pub struct ref_api_s {
    ...
    pub pfnGetCvarPointer: ::core::option::Option<
        unsafe extern "C" fn(name: *const ::core::ffi::c_char) -> *mut cvar_t,
    >,
    pub pfnGetCvarFloat:
    ...
    >,
    pub R_Init_Video:
        ::core::option::Option<unsafe extern "C" fn(type_: ref_graphic_apis_t) -> qboolean>,
    ...
    >,
    pub FS_CopyImage:
        ::core::option::Option<unsafe extern "C" fn(in_: *const rgbdata_t) -> *mut rgbdata_t>,
    ...
    pub Image_CalcImageSize: ::core::option::Option<
        unsafe extern "C" fn(
            type_: ::core::ffi::c_int,
            width: ::core::ffi::c_int,
            height: ::core::ffi::c_int,
